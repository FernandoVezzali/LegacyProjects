...
namespace Store.Tests.Controllers
{
    ...
    public class BrandControllerTest
    {
        ...
        public void IndexShouldReturnThreeProducts()
        {
            ...
            // Assert
            Assert.AreEqual(3, ((IEnumerable<Store.Models.Brand>)result.Model).Count());
        }
        ...
        public void DetailsShouldReturnMicrosoft()
        {
            ...
            // Assert
            Assert.AreEqual("Microsoft", ((Store.Models.Brand)result.Model).Name);
        }
        ...
        public void InvalidModelStateShouldReturnCreateView()
        {
            ...
            // Act
            ViewResult result = controller.Create(new Store.Models.Brand()) as ViewResult;
        ...
        public void CreateShouldRedirectToIndex()
        {
            ...
            // Act
            ActionResult result = controller.Create(new Store.Models.Brand());
